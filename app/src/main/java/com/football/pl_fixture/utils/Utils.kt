...
class Utils {
    ...
    companion object {
        ...
        fun getDates(date: Date, fromTop: Boolean): Pair<String, String> {
            ...
            val dateFrom = org.threeten.bp.Instant.ofEpochMilli(date.time).plus(from.toLong(), ChronoUnit.DAYS)
        ...
        fun daysDifference(localDate: org.threeten.bp.LocalDate): Long {
            return abs(org.threeten.bp.temporal.ChronoUnit.DAYS.between(org.threeten.bp.LocalDate.now(), localDate))
        }

        fun toLocalDate(utcDate: String): org.threeten.bp.LocalDate {
            return org.threeten.bp.LocalDate.parse(utcDate, org.threeten.bp.format.DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss'Z'"))
        }
        ...
        fun toDate(localDate: org.threeten.bp.LocalDate): Date {
